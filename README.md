...
|-------------|------------------|--------------------------|
|  Maxance | Zeka    | zkmance@gmail.com  | Backend[ Modèle, Service, Tris] |
| Fabiola | Sainvry | favry0001@gmail.com |Frontend [  UI FXML, Controller, CSS] |
...
**URL** : [[A COMPLETER : https://github.com/USERNAME/nom-du-projet](https://github.com/favry0001/Laboratoire-2---Immobilier--Maxence--Fabiola.git)]
...
outils/
└── generateur_csv.py            script de génération du jeu de la base de donné
```
